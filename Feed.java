...
public class Feed extends JFrame
{
    Feed()
    {
        ...
        sub.add("IOT"); sub.add("LA"); sub.add("EJ"); sub.add("SPM"); sub.add("AWP");
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                try
                {
                    FileOutputStream out = new FileOutputStream("//C://Users//skyga//OneDrive//Desktop//feedback.txt.txt/");
